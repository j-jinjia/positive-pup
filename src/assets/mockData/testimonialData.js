const testimonials = [
  ...
  },
  {
    ...
    course: "LITTLE STARS COURSE",
    comment:
      "Mel has been absolutely brilliant over the course, super informative and lots of great advice. Ralph is particularly nervous for a pup as he’s so small (mini dachshund) but Mel adapted the layout of the class to help him which was brilliant. We’ve had so much fun and are hoping to have some sessions outside of the classes to work on extra things. Would highly recommend! Xxx",
  },
  {
    id: "testimonial4",
  ...
  },
  {
    ...
    comment:
      "Mel is amazing lady who just understands what life is like with a puppy/dog. She has helped me and Layla gain so much confidence and do things I never thought could happen and I couldn’t thank her enough!. I recommend Mel to anyone who is starting out with a puppy or even a couple years down the line and thinking things need to be taught in a different but positive way. Mel’s courses are so fun me and Layla loved every single session, we made a puppy family and met some amazing people along the way. Mel sends all the sessions in brilliant detail so when you go home you don’t feel like you have forgotten and it can be done in your daily routine. I really can’t wait for me and Layla to start the relaxed rally and carry on seeing Mel because she truly is amazing lady so thank you from Jess and Layla 🐾",
  },
  {
    id: "testimonial6",
